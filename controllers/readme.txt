...
[/how-to/environments Environments are already discussed elsewhere] and a controller will usually simply proxy these methods to it's context (i.e. pass the call back up the controller chain to a single application environment).
