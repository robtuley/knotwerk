<?php
/**
 * Unit test cases for the T_Text_ExternalLink class.
 *
 * @package wikiTests
 * @author Rob Tuley
 * @version SVN: $Id$
...
/**
 * T_Text_ExternalLink unit test cases.
 *
 * @package wikiTests
 * @license http://knotwerk.com/licence MIT
 */
class T_Test_Text_ExternalLink extends T_Test_Text_ElementWithContentHarness
{
    ...
    {
        return new T_Text_ExternalLink($content,$url);
    }
